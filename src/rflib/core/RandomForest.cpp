...
template<typename Sample, typename Label, typename SplitFunction, typename SplitEvaluator, typename LeafNodeStatistics, typename AppContext>
void
RandomForest<Sample, Label, SplitFunction, SplitEvaluator, LeafNodeStatistics, AppContext>::Train(DataSet<Sample, Label>& dataset, Eigen::MatrixXd& latent_variables, Eigen::VectorXd mean, Eigen::VectorXd std)
{
...
RandomForest<Sample, Label, SplitFunction, SplitEvaluator, LeafNodeStatistics, AppContext>::TestAndAverage(DataSet<Sample, Label>& dataset, int d, Eigen::VectorXd mean, Eigen::VectorXd std)
{
...
template<typename Sample, typename Label, typename SplitFunction, typename SplitEvaluator, typename LeafNodeStatistics, typename AppContext>
LeafNodeStatistics
RandomForest<Sample, Label, SplitFunction, SplitEvaluator, LeafNodeStatistics, AppContext>::TestAndAverage(LabelledSample<Sample, Label>* sample, int d, Eigen::VectorXd mean, Eigen::VectorXd std)
{
	...
	return LeafNodeStatistics::Average(tmp_stats, sample, d, mean, std, hough_map, this->m_appcontext);
}
